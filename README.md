<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:6C63FF,100:00D4FF&height=200&section=header&text=¡Hola,%20soy%20Lex!&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Full-Stack%20%7C%20Mobile%20Developer%20%7C%&descAlignY=55&descAlign=50" />
</div>
...
-  Me gusta transformar necesidades reales en productos funcionales
-  La mayoría de mis proyectos nacen de problemas reales del entorno empresarial y operativo
...
|  **nova-control** | Sistema Web para digitalizar procesos de producción en planta | PostgreSQL · NestJS · VueJS  |
|  **aythen** | Sistema de facturación con Inteligencia Artificial para entorno empresarial | React · TypeScript · Redux |
|  **taller-macanico-VIP** | Aplicacion movil y pagina web para la gestion, control y visualización de talleres mecanicos | NestJS ·  VueJS · Flutter | 
...
###  Estado, Arquitectura y Herramientas
...
Me interesa seguir construyendo software que aporte valor real a empresas, especialmente en áreas como:

- automatización de procesos
- sistemas administrativos
- aplicaciones móviles empresariales
- plataformas web internas
- soluciones escalables para operación y gestión
...
<div align="center">
  <a href="https://www.linkedin.com/in/lex-fabi%C3%A1n-7933b0355">
